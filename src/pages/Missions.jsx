...
function Missions() {
    return (
      <div style={{ padding: '2rem' }}>
        ...
        <p>Soins techniques, accompagnement, suivi personnalisé : notre mission est de vous soigner avec humanité et respect de la dignité.</p>
        ...
        <br></br>
        - Surveiller les constantes et l'état clinique,<br></br>
        <br></br>
